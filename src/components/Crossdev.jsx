...
import crosshero from "../assets/images/hero/cross-hero-hire.png";
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <p>
                      Double or triple your business reach with our
                      cross-platform app development services. Hire dedicated
                      mobile app developers that build native-like applications
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-inner-images">
                    ...
                    <div class="infotechno-inner-two  wow move-up">
                      <img class="img-fluid" src={crosshero} alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="text-center">
                    <h2>Hire Dedicated Cross Platform App Developers</h2>
                    <div className="section-under-iosdev text-center mt-30">
                      Cross-platform mobile app development allows you to reduce
                      your app development cost and meet your business needs
                      much more efficiently. However, it requires a lot of
                      talent and technical skill set to develop an app that
                      functions similar to native but has benefits of the
                      cross-application. So, if you are looking for
                      cross-platform developers for hire, consider MultiQoS. We
                      have the best cross-platform mobile application
                      development services, where we utilize the new
                      technologies to meet your business needs efficiently. Our
                      hiring model is flexible and allows you to hire resources
                ...
                <div className="col-lg-12">
                  <div className="section-title-wrap text-center section-space--mb_20">
                    <h3 className="heading">
                      How Hiring Cross Platform App Developers Will Help to
                      Build Innovative and Versatile App?
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Why Hire Cross-Platform Developers From
