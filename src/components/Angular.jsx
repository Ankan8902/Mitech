...
import anghero from "../assets/images/hero/ang.webp";
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <h1 class="font-weight--reguler mb-15">
                      Angular JS <br /> Development Company{" "}
                    </h1>
                    <p>
                      AngularJS has proved to be very effective in simplifying
                      application development. At OverNinja, we are dedicated to
                      providing high-end AngularJS Development Services that
                      help to satisfy your custom project needs.
                    </p>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-inner-images">
                    ...
                    <div class="infotechno-inner-two  wow move-up">
                      <img class="img-fluid android-img" src={anghero} alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Stay On The Top With Flexible And Real-Time
                      <span class="text-color-primary"> Applications</span>
                    </h3>
                  </div>
                  {/* <!-- section-title-wrap Start --> */}
                </div>
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Custom AngularJS Development</h5>
                          <div class="text">
                            We are involved in building performance-driven,
                            scalable, and custom AngularJS apps which provide
                            you an extra edge.
                          </div>
                        </div>
                      </div>
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          ...
                          <div class="text">
                            We always focus on creating interactive and dynamic
                            web pages for desktop and mobile apps with the help
                            of our AngularJS app development services.
                          </div>
                        </div>
                      </div>
                    </a>
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Angular Upgrade Services</h5>
                          <div class="text">
                            To increase the speed of the app development
                            process, we help to upgrade your old AngularJS app
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Custom Widgets Development</h5>
                          <div class="text">
                            Built-in reusable widgets containing fully custom
                            Angular components ensure enhanced functionality and
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Application Migration Service</h5>
                          <div class="text">
                            We are having specialization in migration services
                            which makes sure that the AngularJS apps stay
                            updated with the latest trends in development.
                          </div>
                        </div>
                      </div>
                    </a>
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">
                            AngularJS App Support And Maintenance
                          </h5>
                          <div class="text">
                            Our professional experts make sure that AngularJS
                            apps perform consistently by providing the best
