...
import nativehero from "../assets/images/hero/rnhh.png";
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <p>
                      We build you native-like app experiences for Android and
                      iOS applications for improved engagement on your
                      application. You can hire react native app developer on a
                      full-time, part-time and hourly basis.
                    </p>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-inner-images">
                    ...
                    <div class="infotechno-inner-two  wow move-up">
                      <img class="img-fluid" src={nativehero} alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="text-center">
                    <h2>Dedicated Team of React Native App Developers</h2>
                    <div className="section-under-iosdev text-center mt-30">
                      React Native comes from a trusted name such as Facebook
                      and provides you the ease of development through
                      JavaScript. React Native provides cost-effective solutions
                      to build cross-platform applications for Android and iOS
                      platforms. We are a react native app development company
                      that allows easy development of native-like UX. By hiring
                      react native developers, you get to experience the quality
                      of the code, low development cost, and reduced development
                      time.
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="section-title-wrap text-center section-space--mb_20">
                    <h3 className="heading">
                      How Hiring React Native Developers Will Help to Facilitate
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Why Hire React Native App Developer From
