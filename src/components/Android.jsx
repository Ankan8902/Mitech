...
import androidhero from "../assets/images/hero/androidhero.webp";
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <h1 class="font-weight--reguler mb-15">
                      Android App <br /> Development Company{" "}
                    </h1>
                    <p>
                      Hire the best developers for building apps for the world's
                      leading mobile app development platform. OverNinja
                      provides you custom android app development which allows
                      you to develop feature-rich and high-performing
                      applications. We provide you end-to-end android
                      development services, right from consultation to
                      development to maintenance, which would allow you to stay
                      on the top of the business domain all throughout your
                      business lifecycle.
                    </p>
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Experience the superiority with Android application
                      development
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">UI/UX Design Services</h5>
                          <div class="text">
                            Woo your customers with state-of-the-art app design
                            solutions, ensuring seamless navigation and high
                            customer engagement.
                          </div>
                        </div>
                      </div>
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          ...
                          <div class="text">
                            Feature-rich and high-performing custom android app
                            development on leading android development
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          ...
                          <div class="text">
                            Ensure the quality of the Android application with
                            robust testing for debugging and an unprecedented
                            experience.
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Custom Plugin Development</h5>
                          <div class="text">
                            Improve the efficiency of your application with
                            custom plugins developed to fit perfectly with your
                            existing product.
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">3rd Party Integrations</h5>
                          <div class="text">
                            We provide you with secure 3rd party integration
                            such as payment integration, sales tools, marketing
                            tools, and more.
                          </div>
                        </div>
                      </div>
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          ...
                          <div class="text">
                            Maintain your Android application and upgrade to
                            more robust technology for improved performance and
                            efficiency.
                          </div>
                        </div>
                      </div>
