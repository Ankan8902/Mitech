...
import worhero from "../assets/images/hero/wor.webp";
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <h1 class="font-weight--reguler mb-15">
                      Wordpress <br /> Development Company{" "}
                    </h1>
                    <p>
                      Get the best out of the world’s most popular CMS platform
                      with our WordPress experts. WordPress, the undisputed
                      leader among the CMS platforms, helps you to build robust
                      websites with sophisticated and eye-candy user interface,
                      engaging user experience, customizable features through
                      thousands of plugins and great scalability.
                    </p>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-inner-images">
                    ...
                    <div class="infotechno-inner-two  wow move-up">
                      <img class="img-fluid android-img" src={worhero} alt="" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Accelerate Your Business Growth With Wordpress Development
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Wordpress Web App Development</h5>
                          <div class="text">
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">
                            Wordpress Micro-services Development
                          </h5>
                          <div class="text">
                  ...
                  <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                    ...
                    <a href="/" class="ht-box-images style-04">
                      <div class="image-box-wrap">
                        ...
                        <div class="content">
                          <h5 class="heading">Wordpress Consulting Services</h5>
                          <div class="text">
