...
import image from "../assets/images/icons/mitech-box-image-style-06-image-01-120x120.webp";
import image2 from "../assets/images/icons/mitech-box-image-style-06-image-02-120x120.webp";
import image3 from "../assets/images/icons/mitech-box-image-style-06-image-03-120x120.webp";
import image4 from "../assets/images/hero/about-2.jpg";
import image5 from "../assets/images/hero/contact.jpg";
                ...
                <div className="col-lg-4 offset-lg-1">
                  <div className="modern-number-01">
                    <h2 className="heading  me-5">
                      <span className="mark-text">38</span>Year's Experience in
                      IT
                    </h2>
                      ...
                      <div className="ht-box-images style-06">
                        <div className="image-box-wrap">
                          ...
                          <div className="content">
                            ...
                            <div className="text">
                              We put a strong focus on the needs of your
                              business to figure out solutions that best fits
                              your demand and nail it.
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 wow move-up">
                      ...
                      <div className="ht-box-images style-06">
                        <div className="image-box-wrap">
                          <div className="box-image">
                            <div className="default-image">
                              <img className="img-fulid" src={image2} alt="" />
                            </div>
                          </div>
                          <div className="content">
                            <h5 className="heading">Become our partners?</h5>
                            <div className="text">
                              Our preventive and progressive approach will help
                              you take the lead while addressing possible
                              threats in managing data.
                            </div>
                            <a href="/" className="box-images-arrow">
                              <span className="button-text">Discover now</span>
                              <i className="far fa-long-arrow-right"></i>
                    ...
                    <div className="col-lg-4 col-md-6 wow move-up">
                      ...
                      <div className="ht-box-images style-06">
                        <div className="image-box-wrap">
                          <div className="box-image">
                            <div className="default-image">
                              <img className="img-fulid" src={image3} alt="" />
                            </div>
                          </div>
                          <div className="content">
                            <h5 className="heading">Need a hand?</h5>
                            <div className="text">
                              Our support team is available 24/7 a day, 7 days a
                              week and can get ready for solving any of your
                              situational rising problems.
                            </div>
                            <a href="/" className="box-images-arrow">
                              <span className="button-text">Discover now</span>
                              <i className="far fa-long-arrow-right"></i>
                ...
                <div className="delivering-optimal-wrap">
                  ...
                  <div className="list-item">
                    ...
                    <div className="title-wrap">
                      ...
                      <div className="desc">
                        It's more than a responsibility but a guarantee from us
                        to gain customer trust with highly reliable quality
                        control system.{" "}
                      </div>
                    </div>
                  </div>
                ...
                <div className="delivering-optimal-wrap">
                  ...
                  <div className="list-item">
                    ...
                    <div className="title-wrap">
                      ...
                      <div className="desc">
                        Information security has been a rising issue lately due
                        to a series of scandals from big companies, rest
                        assured, we're here.{" "}
                      </div>
                    </div>
                  </div>
