...
import image2 from "../assets/images/hero/choose-1.jpg";
import image3 from "../assets/images/hero/choose-2.jpg";
import image4 from "../assets/images/hero/choose-3.jpg";
                ...
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    ...
                    <p class="title-dec-text">
                      The IT services that Mitech are running can be segmented
                      by the type of skills employed to deliver the service
                      (design, build, run). Technically, these fall into three
                      main categories: business process services, application
                      ...
                      <div class="progress-charts ">
                        ...
                        <div class="progress">
                          <div
                            ...
                            aria-valuemax="100"
                          >
                            <span class="percent-label">89%</span>
                          </div>
                        </div>
                      </div>
                      {/* <!-- End Single Progress Charts --> */}
                          ...
                          <div class="box-large-image__box">
                            ...
                            <div class="box-large-image__content mt-30 text-center">
                              <p>
                                Our technical experts have a flair for
                                developing <strong>clean-coded websites</strong>{" "}
                                based on customers’ needs, global guidelines and
                                trends.
                              </p>
                            </div>
                          </div>
