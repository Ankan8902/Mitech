                ...
                <div class="col-lg-6 col-md-6">
                  <div class="infotechno-hero-text  wow move-up">
                    ...
                    <h1 class="font-weight--reguler mb-15">
                      POS <br /> Development Company{" "}
                    </h1>
                    <p>
                      POS is one of the most resource-rich and
                      performance-driven frameworks that web projects all over
                      the globe prefer. OverNinja offers one of the leading POS
                      development services with an experienced team of skilled
                      Laravel developers who built several award winning Laravel
                      apps.
                    </p>
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="section-title-wrap text-center section-space--mb_30">
                    <h3 class="heading">
                      Accelerate Your Business Growth With POS Development
